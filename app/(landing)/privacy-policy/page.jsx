...
const PrivacyPolicyPage = () => {
    return (
        <div className="flex flex-col w-full justify-center items-center px-6">
            <div className="flex flex-col w-full max-w-[1272px] items-center gap-6 py-6">
                ...
                <div className="flex flex-col justify-center items-center gap-4">
                    ...
                    <span className="text-lg md:text-xl text-[#8F8F8F]">Last Updated: 01/01/2026</span>
                </div>
            </div>
            <div className="flex flex-col w-full max-w-[1272px] gap-6 md:gap-8 pb-6 md:py-10">
                <span className="text-xl">This Privacy Policy explains how personal information is collected, used, and protected when you interact with us through our website or sign up to receive email or text message communications. <br />
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xl">Message frequency may vary
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="px-1.5"><div className="size-1.25 rounded-full bg-[#2A2A2A]"></div></div>
                            <span className="text-xl">You may opt out at any time
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="px-1.5"><div className="size-1.25 rounded-full bg-[#2A2A2A]"></div></div>
                            <span className="text-xl">Reply STOP to any text message
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="px-1.5"><div className="size-1.25 rounded-full bg-[#2A2A2A]"></div></div>
                            <span className="text-xl">Use the unsubscribe link in emails
                            </span>
                        </div>
                    </div>
                    <span className="text-xl">
                ...
                <div className="flex flex-col gap-3">
                    <h1 className="text-primary font-medium text-2xl tracking-tight">
                        Hello@sundaygirl.space
                    </h1>
                    <h1 className="text-primary font-medium text-2xl tracking-tight">
