...
import { RestrictUserIcon } from "@/components/icons/icons";

const inter = Inter({ subsets: ["latin"] });

const RestrictUserDialog = ({ isOpen, onOpenChange, onConfirm }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        <VisuallyHidden.Root>
          ...
          <DialogDescription>
            Confirmation to restrict the selected user.
          </DialogDescription>
        </VisuallyHidden.Root>
        <div className="p-6 sm:p-10 flex flex-col items-center text-center relative">
          ...
          <div className="w-[80px] h-[80px] bg-[#FAFAFA] rounded-full flex items-center justify-center mb-6">
            <RestrictUserIcon className="w-6 h-6 text-[#24282E]" />
          </div>
