...
const UserDetailsDialog = ({ isOpen, onOpenChange, user, onRestrict }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent
        className="w-[calc(100%-2rem)] lg:max-w-[820px] p-0 border border-[#F2F2F2] rounded-[24px] overflow-hidden flex flex-col gap-0 shadow-2xl bg-white fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-auto lg:right-8 lg:top-8 lg:translate-x-0 lg:translate-y-0"
      ...
      >
        ...
        <div className="p-4 sm:p-8 bg-white">
          {/* Inner Card */}
          <div className="border border-[#F2F2F2] rounded-[24px] p-4 sm:p-8 flex flex-col sm:flex-row gap-6 sm:gap-10 bg-white">
            {/* User Details Left */}
            <div className="flex flex-col items-center sm:min-w-[140px]">
              <p className="text-[16px] font-bold text-[#24282E] mb-6 self-start tracking-tight">
                User Details
              </p>
              ...
              <h3 className="text-[18px] font-bold text-[#24282E] mb-0.5">
                {user.name}
              </h3>
            ...
            <div className="flex-1 pt-2">
              <p className="text-[16px] font-bold text-[#24282E] mb-8 tracking-tight">
                Info Details
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-10">
                <div>
                  <p className="text-[15px] font-medium text-[#8F95B2] mb-2">
                    Date Joined
                  </p>
                ...
                <div>
                  ...
                  <p className="text-[16px] font-bold text-[#24282E]">
                    {user.practices || "12"}
                  </p>
                </div>
                <div>
        ...
        {/* Footer */}
        <div className="px-8 py-5 border-t border-[#F2F2F2] bg-white flex items-center justify-end gap-3 shrink-0">
          <Button
            variant="outline"
            className="border-[#E07386] text-[#E07386] hover:bg-[#FFF5F6] rounded-[12px] h-12 px-8 font-bold transition-all text-[15px]"
            onClick={() => {
          ...
          <Button
            className="bg-[#E07386] hover:bg-[#d06376] text-white rounded-[12px] h-12 px-10 font-bold shadow-md transition-all text-[15px]"
