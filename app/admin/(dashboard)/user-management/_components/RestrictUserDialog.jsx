  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <p className="text-[16px] text-[#6C6C6C] text-center mb-10 max-w-[380px] leading-relaxed">
        ...
        <div className="flex items-center justify-center gap-4 w-full">
          <Button
            variant="outline"
            className="flex-1 border-[#E07386] text-[#E07386] hover:bg-[#FFF5F6] rounded-[16px] h-14 font-bold text-[16px] transition-all"
            onClick={() => onOpenChange(false)}
          >
            Cancel
          </Button>
          <Button
            className="flex-1 bg-[#E07386] hover:bg-[#d06376] text-white rounded-[16px] h-14 font-bold text-[16px] shadow-lg shadow-[#E07386]/20 transition-all border-0"
            onClick={() => {
