...
const EditPracticeDialog = ({ isOpen, onOpenChange, video, title, onDelete }) => {
    // Determine the preview image based on the title/tab
    const previewImage = title === "Soft Spark"
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent
                className="max-w-[560px] w-full h-[657px] p-0 border border-[#F2F2F2] rounded-[20px] overflow-hidden flex flex-col gap-0 shadow-2xl bg-white fixed left-auto right-6 top-1/2 -translate-y-1/2 translate-x-0"
            ...
            >
                ...
                <div className="px-8 py-6 border-b border-[#F2F2F2] flex items-center justify-between bg-white shrink-0">
                    <h2 className={`${degular.className} text-[22px] text-[#24282E]`}>{title}</h2>
                    <DialogClose asChild>
                ...
                <div className="p-8 bg-white flex-1 overflow-y-auto">
                    ...
                    <div className="bg-white rounded-[24px] border border-[#F2F2F2] p-6 flex items-center justify-between shadow-[0px_4px_30px_rgba(0,0,0,0.01)]">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <h4 className="text-[18px] font-bold text-[#24282E] mb-1">File name here</h4>
