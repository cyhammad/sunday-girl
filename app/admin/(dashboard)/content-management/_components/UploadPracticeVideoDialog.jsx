    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <VisuallyHidden.Root>
          ...
          <DialogDescription>
            Form to upload a new practice video including title, description and
            video file.
          </DialogDescription>
        </VisuallyHidden.Root>
        ...
        <div className="px-10 pb-2 bg-white flex-1 overflow-y-auto">
          ...
          <div className="border-2 border-dashed border-[#E5E7EB] rounded-[24px] py-14 px-10 flex flex-col items-center justify-center text-center bg-white group cursor-pointer hover:border-[#E07386] transition-colors">
            ...
            <h3 className="text-[20px] font-bold text-[#24282E] mb-2">
              Upload Video
            </h3>
            <p className="text-[#8F8F8F] text-[16px] max-w-[450px] leading-relaxed">
              Upload the 'This Week's Practice' video to introduce new users to
              our platform.
            </p>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="p-10 bg-white flex items-center justify-center gap-4 shrink-0">
          <Button
            variant="outline"
