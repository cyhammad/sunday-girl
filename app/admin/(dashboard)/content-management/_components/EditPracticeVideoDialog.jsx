        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            >
                ...
                <VisuallyHidden.Root>
                    ...
                    <DialogDescription>
                        Form to edit the practice video details including title, description and video file.
                    </DialogDescription>
                </VisuallyHidden.Root>
                ...
                <div className="px-10 py-8 flex items-center justify-between bg-white shrink-0">
                    <div className="flex items-center gap-4">
                        <h2 className={`${degular.className} text-[28px] text-[#24282E]`}>Edit Practice Video</h2>
                    </div>
                ...
                <div className="px-10 pb-2 bg-white flex-1 overflow-y-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <textarea
                            defaultValue={video?.description || "A video tutorial on how to improve your vertical jump. Learn the techniques from coach Sadora. Filmed in the Ascent gym."}
                            placeholder="Enter"
                            rows={4}
