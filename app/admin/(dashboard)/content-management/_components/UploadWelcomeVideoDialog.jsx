...
const UploadWelcomeVideoDialog = ({ isOpen, onOpenChange }) => {
  const title = "Upload Welcome Video";
  const explanation =
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        <VisuallyHidden.Root>
          ...
          <DialogDescription>
            Step to upload a new welcome to sunday girl video to the platform.
          </DialogDescription>
        </VisuallyHidden.Root>
...
export default UploadWelcomeVideoDialog;
