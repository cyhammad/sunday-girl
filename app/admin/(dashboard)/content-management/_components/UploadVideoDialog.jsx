        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            ...
            >
                ...
                <VisuallyHidden.Root>
                    ...
                    <DialogDescription>
                        Step to upload a new {type?.toLowerCase() || "video"} to the platform.
                    </DialogDescription>
                </VisuallyHidden.Root>

                {/* Header */}
                <div className="px-10 py-8 flex items-center justify-between bg-white shrink-0">
                    <h2 className={`${degular.className} text-[28px] text-[#24282E]`}>{title}</h2>
                    <DialogClose asChild>
                ...
                {/* Content Area */}
                <div className="px-10 pb-2 bg-white">
                    <div className="mb-8">
                    ...
                    {/* Upload Box */}
                    <div className="border-2 border-dashed border-[#E5E7EB] rounded-[24px] py-16 px-10 flex flex-col items-center justify-center text-center bg-white group cursor-pointer hover:border-[#E07386] transition-colors">
                        ...
                        <h3 className="text-[20px] font-bold text-[#24282E] mb-3">Upload Video</h3>
