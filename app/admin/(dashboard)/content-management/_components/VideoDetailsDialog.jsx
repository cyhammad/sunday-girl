...
const VideoDetailsDialog = ({
  ...
  const practiceFeed = [
    {
      ...
      content:
        "Embrace the stillness and breathe in the beauty of nature. #NatureTherapy #Mindfulness",
      likes: 12,
      comments: 2,
      image:
    ...
    },
    {
      ...
      content:
        "Finding peace in the simple things. A walk in the park does wonders for the soul. #NatureLover #InnerPeace",
      likes: 8,
      comments: 0,
      image:
    ...
    },
    {
      ...
      content:
        "Letting nature be your guide and your peace. #FindYourPark #MindfulMoments",
      likes: 15,
      comments: 1,
      image:
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent
        className="w-[calc(100%-2rem)] lg:max-w-[737px] h-[95vh] p-0 border-0 rounded-[20px] overflow-hidden flex flex-col gap-0 shadow-2xl fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-auto lg:right-6 lg:translate-x-0"
        ...
        <div className="flex-1 overflow-y-auto p-2 bg-white">
          ...
          <div className="bg-white rounded-[24px] border border-[#F2F2F2] p-4 sm:p-8 shadow-[0px_4px_30px_rgba(0,0,0,0.01)] mb-8">
            ...
            <p className="text-[#6C6C6C] text-[15px] leading-relaxed mb-8">
              This week's video focuses on a healthy practice to improve your
              overall well-being. This week, we'll guide you through a gentle
              yet effective routine that's perfect for women at any stage of
              their wellness journey.
            </p>

            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-8 mb-8 border-t border-[#F2F2F2] pt-6">
              <div>
                <label className="text-[13px] text-[#8F8F8F] block mb-1">
                  People Joined
                </label>
                <p className="text-[15px] font-semibold text-[#24282E]">
                  45 people joined
                </p>
              </div>
              <div>
          ...
          <div className="bg-white rounded-[24px] border border-[#F2F2F2] p-4 sm:p-8 shadow-[0px_4px_30px_rgba(0,0,0,0.01)]">
            ...
            <div className="flex flex-col gap-8">
              {practiceFeed.map((post) => (
                <div
                  key={post.id}
                  className="border-b border-[#F2F2F2] pb-8 last:border-0 last:pb-0"
                >
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* Post Text */}
                      <p className="text-[#6C6C6C] text-[14px] leading-relaxed mb-4">
                        {post.content}
                      </p>
                    ...
                    <div className="hidden sm:flex items-center gap-3 shrink-0">
                      <div className="relative w-[140px] h-[110px] rounded-[12px] overflow-hidden shadow-sm">
                        <Image
                          src={post.image}
                          alt="Feed content"
                          fill
