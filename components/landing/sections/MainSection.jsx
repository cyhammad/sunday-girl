...
const MainSection = () => {
  return (
    <div
      className="flex w-full sm:gap-6 gap-2 flex-col text-center text-white items-center justify-center min-h-[771px] sm:min-h-[632px] h-full bg-cover bg-center"
    ...
    >
      ...
      <Button size="xl" className="mt-5.5 text-2xl sm:text-3xl h-[63px] px-8 gap-1.5 sm:h-[74px]">
        I'm so in
