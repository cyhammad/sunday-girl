    ...
    <div className="grid lg:grid-cols-2 gap-8 w-full self-center max-w-360 rounded-2xl overflow-hidden">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <button
            className="size-24 rounded-full bg-white/16 border border-white/25 hover:bg-white transition-colors flex items-center justify-center shadow-lg"
      ...
      <div className="flex-1 md:text-2xl text-lg bg-white rounded-2xl flex flex-col w-full items-start gap-8 p-8 lg:p-12 xl:p-16">
        ...
        <p>It's all so... loud.</p>
        <p>What if all you needed was space?</p>
        <p>
